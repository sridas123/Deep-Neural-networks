...
path='D:/git/Neuralnet/Graphs/Gradient_last_1000/'
...
plt.savefig(path+'Back_propagated_gradient_layer1.png', bbox_inches='tight')
plt.clf()
plt.cla()

fig1 = plt.figure()
ax = fig1.add_subplot(111)
for grad, color in zip(bfarray[1:], COLORS[1:]):
    ax.plot(np.arange(NUM_EPOCHS), grad, "o-",
            label="$layer$ = "+str(i),
            color=color)
    i=i+1  
...
ax.set_ylabel('Back_propagated gradients')
plt.legend(loc='upper right')
plt.savefig(path+'Back_propagated_gradient_layer2.png', bbox_inches='tight')
plt.clf()
plt.cla()

fig2 = plt.figure()
ax = fig2.add_subplot(111)
for grad, color in zip(bfarray[2:], COLORS[2:]):
    ax.plot(np.arange(NUM_EPOCHS), grad, "o-",
            label="$layer$ = "+str(i),
            color=color)
    i=i+1  
...
ax.set_ylabel('Back_propagated gradients')
plt.legend(loc='upper right')
plt.savefig(path+'Back_propagated_gradient_layer3.png', bbox_inches='tight')
plt.clf()
plt.cla()

fig3 = plt.figure()
ax = fig3.add_subplot(111)
for grad, color in zip(bfarray[3:], COLORS[3:]):
    ax.plot(np.arange(NUM_EPOCHS), grad, "o-",
            label="$layer$ = "+str(i),
            color=color)
    i=i+1  
...
ax.set_ylabel('Back_propagated gradients')
plt.legend(loc='upper right')
plt.savefig(path+'Back_propagated_gradient_layer4.png', bbox_inches='tight')
plt.clf()
plt.cla()

fig4 = plt.figure()
ax = fig4.add_subplot(111)
for grad, color in zip(bfarray[4:], COLORS[4:]):
    ax.plot(np.arange(NUM_EPOCHS), grad, "o-",
            label="$layer$ = "+str(i),
            color=color)
    i=i+1  
...
ax.set_ylabel('Back_propagated gradients')
plt.legend(loc='upper right')
plt.savefig(path+'Back_propagated_gradient_layer5.png', bbox_inches='tight')
plt.clf()
plt.cla()
